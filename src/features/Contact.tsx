    ...
    return (
        <section ref={ref} className="relative py-24 px-4 z-1">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <h2 className="section-title text-pinball-red">{t('contact.title')}</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                      ...
                      ${info.href ? 'hover:border-pinball-red/50 cursor-pointer' : ''}
                      transition-all duration-300`}
                                    >
                                        <div className="p-3 rounded-lg bg-pinball-red/10 text-pinball-red
