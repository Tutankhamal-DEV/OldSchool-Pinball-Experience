...
const MACHINES: Machine[] = [
  ...
  // ── Arcades & Other Games ──
  {
    name: "Bebometro",
    category: "arcade",
    detail: "machines.machine_details.sobriety_test",
  },
  {
    name: "Lucky & Wild",
    category: "arcade",
    year: 1993,
    detail: "machines.machine_details.shooting_arcade",
  },
  {
    name: "Mini Arcade Classics",
    category: "arcade",
    detail: "machines.machine_details.multi_game_3x",
  },
  {
    name: "Pandora 6",
    category: "arcade",
    detail: "machines.machine_details.multi_game_2x",
  },
  {
    name: "Pandora Alpha Plus",
    category: "arcade",
    detail: "machines.machine_details.multi_game",
  },
  {
    name: "Pebolim",
    category: "arcade",
    detail: "machines.machine_details.foosball",
  },
  {
    name: "Pong",
    category: "arcade",
    detail: "machines.machine_details.digital_ping_pong",
  },
  {
    name: "Real Puncher",
    category: "arcade",
    detail: "machines.machine_details.punch",
  },
  ...
  },
  {
    name: "Vortex",
    category: "arcade",
    detail: "machines.machine_details.reflex_test",
  },
];
...
const BANNER_SLIDES = [
  { src: "/images/ambiente_04.webp", mobile: "/images/ambiente_04-sm.webp" },
  {
    ...
    mobile: "/images/pinball_machines_1-sm.webp",
  },
  ...
  return (
    <section id="maquinas" ref={ref} className="relative py-24 px-4 z-1">
      <div className="max-w-6xl mx-auto">
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2 overflow-hidden w-full">
                          <span
                            className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${
                              machine.category === "pinball"
                                ? "bg-pinball-red"
                                : "bg-pinball-neon-blue"
                          ...
                          <p className="font-tech text-xs sm:text-sm text-pinball-cream/80 group-hover:text-pinball-yellow transition-colors duration-300 truncate">
                            {machine.name}{" "}
                            {machine.detail && (
                              <span className="opacity-50 text-[9px] sm:text-[10px] ml-1 uppercase">
                                {t(machine.detail)}
                              </span>
                            )}
                          </p>
        ...
        >
          {sortedMachines.length} {t("machines.count_machines")}{" "}
          {t("machines.count_total")}
        </motion.p>
      </div>
    </section>
  );
