            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-8">
                    ...
                    <div className="text-center sm:text-left">
                        <h3 className="font-pixel text-pinball-yellow text-xs mb-3">OLD SCHOOL</h3>
                    ...
                    <div className="text-center sm:text-left">
                        <h4 className="font-tech text-pinball-cream/70 text-sm mb-3 uppercase tracking-wider">{t('footer.links_title')}</h4>
                    ...
                    {/* Social */}
                    <div className="text-center sm:text-left">
                        <h4 className="font-tech text-pinball-cream/70 text-sm mb-3 uppercase tracking-wider">{t('footer.social_title')}</h4>
